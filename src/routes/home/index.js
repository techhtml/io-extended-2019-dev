...
const Home = () => (
	<div class="home io-2019-extended">
		...
		<section class={style.partnerSection}>
			<h1 class={style.partnerTitle}>Partners</h1>
			<section class={style.partnerGroup}>
				<h2 class="h2">Host</h2>
				<div class={style.partnerList}>
					<div class={style.partnerItem}>
						<Google class={style.partnerLogo} />
					</div>
				</div>
			</section>
			<section class={style.partnerGroup}>
